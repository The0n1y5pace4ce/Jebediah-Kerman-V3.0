...
const configJson = require('../../Structures/config.json')
...
const config = {
    ...
    "YOUTUBERS": [
        "https://www.youtube.com/feeds/videos.xml?channel_id=UCMldAiUDEt53cUo-Qk6F3Rw"
    ],
    "DISCORD_CHANNEL_ID": configJson.YT_CHANNEL_ID,
    "YOUTUBE_API_KEY": configJson.YT_KEY
};
...
module.exports = {
    ...
    async execute(client) {
        ...
        check();
        setInterval(check, 30 * 1000); //30 seconds
